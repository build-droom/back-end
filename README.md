...
GET GET LIST OF ALL MATCHES THAT WERE SAVED BY EVERYONE
https://droombwlambda.herokuapp.com/api/matches/
This is where you get a list of all matches that have been liked and saved by all users. (companies of job seekers.)

GET https://droombwlambda.herokuapp.com/api/matches/

HEADERS
AuthorizationeyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..uN3DzsqfmwLG39K6YB762XEp48eRgHjErhkXDDgsBWg
Content-Typeapplication/json

BODY raw
{
"seekers_id":1,NOT NULLABLE
"joblisting_id":3,NOT NULLABLE
"fave_of_seeker":true,
"fave_for_job":false,
"matched_occupation":true
}

GET GET list of ALL SAVED job matched entries by id of seeker who entered it(FAVORITE OF SEEKER)
queries all matches matching seekers id and with fave_of_seeker =true

https://droombwlambda.herokuapp.com/api/matches/faveofseeker/1
https://droombwlambda.herokuapp.com/api/matches/faveofseeker/1
...
GET GET LIST OF SEEKERS WHO ARE LIKED BY COMPANY FOR SPECIFIED JOBLISTING
Queries all matches matching seekers id and with fave_of_seeker =true

https://droombwlambda.herokuapp.com/api/matches/faveofcomp/6

THE id number at the end of the request is the id of the joblisting from the company.
...
"fave_of_seeker":true,
"fave_for_job":false,
"matched_occupation":true ALWAYS TRUE
}
